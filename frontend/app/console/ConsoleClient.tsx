    ...
    <div className="relative h-screen bg-black cyber-grid overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full min-h-0">
        ...
        <header className="flex items-center justify-between px-6 pt-4 pb-8 md:px-12 md:pt-6 md:pb-10 border-b-2 border-white">
          ...
          {/* Right: Import button and Settings */}
          <div className="flex items-center gap-3">
            <ImportButton />
            {/* Settings button - gear icon */}
            <button
              onClick={() => setIsSettingsOpen(true)}
              className="p-2 border-2 border-white/40 hover:border-white hover:bg-white/5 transition-colors"
      ...
      {/* Settings modal for user preferences (phone number, etc.) */}
      <SettingsModal
